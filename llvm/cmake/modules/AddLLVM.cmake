...
function(llvm_add_library name)
  ...
  if(ARG_OBJLIBS)
    set(ALL_FILES ${ARG_OBJLIBS} "../../lib/Target/HCS12/TargetInfo/MSP430TargetInfo.cpp" "../../lib/Target/HCS12/TargetInfo/MSP430TargetInfo.h")
  else()
  ...
  if((ARG_SHARED AND ARG_STATIC) OR ARG_OBJECT)
    ...
    set(ALL_FILES "$<TARGET_OBJECTS:${obj_name}>" ${DUMMY_FILE} "../../lib/Target/HCS12/TargetInfo/MSP430TargetInfo.cpp" "../../lib/Target/HCS12/TargetInfo/MSP430TargetInfo.h")
  ...
  elseif(ARG_SHARED)
    ...
    add_library(${name} STATIC ${ALL_FILES} "../../lib/Target/HCS12/TargetInfo/MSP430TargetInfo.cpp" "../../lib/Target/HCS12/TargetInfo/MSP430TargetInfo.h")
  endif()
